  ...
  <section>
    <el-card class="box-card" shadow="never">
      <div slot="header" class="clearfix" style="position: relative">
        <span v-if="$route.params.id > 0">企业详情</span>
        <span v-else>新建企业</span>
          <!-- <el-button style="position: absolute; right: 70px;" size="small" type="primary" @click="add" v-if="$isViewBtn('110009')">保存</el-button> -->
      ...
      <el-row>
        ...
        <el-col :span="18" style="padding-right: 20px;">
          <el-form ref="form" :rules="rules"  :model="enterpriseInfo" size="small" label-width="160px" @submit.prevent="onSubmit" :disabled="true">
            <el-col :span="12">
              <el-form-item label="统一社会信用代码" prop="TYSHXYDM">
                <el-input size="small" v-model="enterpriseInfo.TYSHXYDM" maxlength="30"></el-input>
              </el-form-item>
              ...
              <el-form-item label="税务登记号" prop="SWDJH">
                <el-input size="small" v-model="enterpriseInfo.SWDJH" maxlength="30"></el-input>
              </el-form-item>
              <el-form-item label="组织机构代码证" prop="ZZJGDM">
                <el-input size="small" v-model="enterpriseInfo.ZZJGDM" maxlength="30"></el-input>
              </el-form-item>
              <el-form-item label="法人身份证号" prop="FRDBZJHM">
                <el-input size="small" v-model="enterpriseInfo.FRDBZJHM" maxlength="30"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              ...
              <el-form-item label="营业执照编号" prop="YYZZBH">
                <el-input size="small" v-model="enterpriseInfo.YYZZBH" maxlength="30"></el-input>
              </el-form-item>
              <el-form-item label="法人姓名" prop="FRDBXM">
                <el-input size="small" v-model="enterpriseInfo.FRDBXM" maxlength="30"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="24">
              <el-form-item label="企业详址" prop="MLXZ">
                <el-input size="small" type="textarea" :autosize="{ minRows: 2, maxRows: 5}" v-model="enterpriseInfo.MLXZ" maxlength="100"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="24">
              <el-form-item label="经营范围">
                <el-input size="small" type="textarea" :autosize="{ minRows: 2, maxRows: 5}" v-model="enterpriseInfo.JYFWZY" maxlength="200"></el-input>
              </el-form-item>
            </el-col>
          </el-form>
        </el-col>
      </el-row>
      <Tab :tabData="tabData" :enterpriseInfo="enterpriseInfo" :id="$route.params.id" :jgbh="jgbh" style="margin-top: 20px;"
      @listen2="listenToChild2" @listen3="listenToChild3"></Tab>
    </el-card>
  </section>
</template>
<script>
...
export default {
  data() {
    return {
      ...
      DJZTLable: '',
      tabData: [
        { title: '营业执照信息', content: 'BusinessLicenseInfo', isShow: true },
        ...
        { title: '涉案案件', content: 'InvolvedCase', isShow: true },
        { title: '从业人员', content: 'CompanyPerson', isShow: true }
  ...
  methods: {
    listenToChild2(evtValue) { // 涉案案件
      if (evtValue === '0') {
        this.tabData[1].isShow = false // 隐藏掉涉案案件
      }
    },
    listenToChild3(evtValue) { // 从业人员
      if (evtValue === '0') {
        this.tabData[2].isShow = false // 隐藏从业人员
      }
    },
    tcode(type) {
      const para = {
