<template>
  <section>
    <!-- 摊贩信息 -->
    <el-form :inline="true" :model="filters" size="small" label-width="110px" label-position="left">
      <el-form-item label="摊位名称：">
        <el-input size="small" clearable v-model="filters.name" placeholder="请输入摊位名称" maxlength="10"></el-input>
      </el-form-item>
      <el-form-item label="负责人名称：">
        <el-input size="small" clearable v-model="filters.personName" placeholder="请输入负责人名称" maxlength="10"></el-input>
      </el-form-item>
      ...
      <el-form-item label="摊位位置：">
        <el-input size="small" clearable v-model="filters.address" placeholder="请输入摊位位置" maxlength="50"></el-input>
      </el-form-item>
    ...
    <el-table :data="pedlarList"  v-loading="listLoading" style="width: 100%;" :max-height="tableHeight">
      ...
      <el-table-column prop="name" label="摊位名称"  show-overflow-tooltip></el-table-column>
      <el-table-column prop="personName" label="负责人" show-overflow-tooltip></el-table-column>
      <el-table-column prop="cardNumber" label="身份证号码" width="180" show-overflow-tooltip></el-table-column>
      ...
      <!-- <el-table-column prop="address" label="摊位位置" min-width="140" show-overflow-tooltip></el-table-column> -->
    ...
    <!-- 导入弹框 -->
    <el-dialog title="摊贩导入" :visible.sync="dialogImportVisible" size="small" @close="back('importInfo')" class="comDialog">
      <el-form ref="importInfo" size="small" :model="importInfo" label-width="100px" v-loading="importLoading">
        <!-- <el-form-item label="类别：">
          <el-select size="small" clearable filterable v-model="importInfo.LB" placeholder="企业类型" disabled="true">
            <el-option value="1" label="摊贩信息"></el-option>
          </el-select>
        </el-form-item> -->
        <el-form-item label="下载模板："  >
          <a :href="downLoadUrl+'摊位信息模板.xls'"  download="摊位信息模板.xls">
            <el-button type="primary">下载摊贩信息模板</el-button>
          </a>
        </el-form-item>
    ...
    <!-- 审核 -->
    <el-dialog title="企业审核" :visible.sync="auditVisible" :close-on-click-modal=false @close="back('auditFormInfo')" class="dialogWrap">
      <el-form :model="auditFormInfo" size="small" ref="auditFormInfo" :rules="rules" label-width="104px">
        <el-row>
          <el-col :span="22">
