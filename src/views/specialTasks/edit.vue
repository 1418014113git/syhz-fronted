    ...
    <el-row type="flex" justify="center">
      <el-col :span="18">
        ...
        <el-form :model="form" size="small" ref="form" :rules="rules" label-width="140px">
          ...
          <el-form-item>
            <el-button type="primary" @click="edit(false,true)" v-if="$isViewBtn('102008')">保 存</el-button>
            <el-button type="primary" @click="edit(true,true)" v-if="$isViewBtn('102009')">直接发布</el-button>
