      ...
      <el-row type="flex" justify="center">
        <el-col :span="18">
          ...
          <el-form :model="information" size="small" ref="form" :rules="rules" label-width="140px">
            ...
            <el-form-item label="线索来源：" prop="collectionTypeId">
            ...
            <el-form-item label="采集地点：" prop="collectionLocation">
              <el-cascader
                ref="myCascader"
                class="input_w"
                :options="xzqhOptions"
            ...
            <el-form-item label="位置信息：" prop="collectionCoordinate">
              <div @click="mapDialog()">
                <el-input v-model="information.collectionCoordinate" placeholder="位置信息" size="small" class="input_w" clearable :readonly="true"></el-input>
              </div>
            ...
            <el-form-item align="center">
              <el-button type="primary" @click="edit()" class="saveBtn">提交</el-button>
      ...
      rules: {
        ...
        collectionLocation: [{
          required: false, trigger: 'change', validator: (rule, value, callback) => {
            if (this.information.collectionTypeId === '1' || this.information.collectionTypeId === '2' || this.information.collectionTypeId === '3') {
              callback()
            } else {
        ...
        collectionCoordinate: [{
          required: false, message: '', trigger: 'blur', validator: (rule, value, callback) => {
            if (this.information.collectionTypeId === '1' || this.information.collectionTypeId === '2' || this.information.collectionTypeId === '3') {
              callback()
            } else {
              if (value === undefined || value === null || value === '') {
                callback(new Error('请在地图选择位置信息'))
              } else {
                callback()
              }
            }
    ...
    init() {
      this.$query('citytree', { cityCode: '610000' }, 'upms').then((response) => {
        if (response.code === '000000') {
          this.xzqhOptions = response.data ? response.data[0].children : []
        }
      }).catch(() => {
