      ...
      <el-card class="box-card" >
        ...
        <div style="overflow:auto;"   :style="{maxHeight:tableHeight}">
          <div v-for="item in dataList" :key="item.value" class="lineStyle" @click='detail(item.id)'>
            <el-col :span="21" style="word-break: keep-all; text-overflow: ellipsis; font-size: 16px; font-weight: bold; cursor: pointer;">{{ item.title }} &nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <el-col :span="3" style="color: #c7c7c7;">发布日期：{{ $parseTime(item.publishTime, '{y}-{m}-{d}') }}</el-col>
