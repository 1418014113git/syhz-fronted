      ...
      <el-row type="flex" justify="center" style="margin-top:15px;">
        <el-col :span="18">
          <el-form :model="infoForm" size="small" ref="form" :rules="rules" label-width="110px">
            <el-form-item label="积分规则名" prop="integralName">
              <el-input v-model="infoForm.integralName" size="small" maxlength="30"></el-input>
            </el-form-item>
            <el-form-item label="类别" prop="syhFllb">
              <el-select v-model="infoForm.syhFllb" placeholder="食品">
            ...
            <el-form-item label="分类" prop="lawCategory">
              <el-select v-model="infoForm.lawCategory" placeholder="法律">
            ...
            <el-form-item label="每次积分" prop="num">
              <el-input-number v-model="infoForm.num" @change="handleChange" :min="1" :max="10" label="描述文字" style="width: 200px;"></el-input-number>
            </el-form-item>
            <el-form-item label="每日上限" prop="dayNum">
              <el-input-number v-model="infoForm.dayNum" @change="handleChange" :min="1" :max="50" label="描述文字" style="width: 200px;"></el-input-number>
            </el-form-item>
            <el-form-item label="每月上限" prop="mouthNum">
              <el-input-number v-model="infoForm.mouthNum" @change="handleChange" :min="1" :max="500" label="描述文字" style="width: 200px;"></el-input-number>
            </el-form-item>
            <el-form-item>
