      ...
      <el-row type="flex" justify="center" style="margin-top:15px;">
        <el-col :span="18">
          <el-form :model="infoForm" size="small" ref="form" :rules="rules" label-width="110px">
            <el-form-item label="标题" prop="meansName">
              <el-input v-model="infoForm.meansName" size="small" maxlength="30">烟酒毒危害</el-input>
            </el-form-item>
            ...
            <el-form-item label="浏览时长">
              <el-select v-model="infoForm.issueDate" placeholder="10分钟">
            ...
            <el-form-item label="发布日期">
              <el-date-picker v-model="infoForm.enforcementDate"  type="date" placeholder="施行日期">2019-01-02</el-date-picker>
            </el-form-item>
            <el-form-item label="状态" prop="enabled">
              <el-select v-model="infoForm.enabled" placeholder="可读">
            ...
            <el-form-item label="详情" prop="content">
              <vue-editor v-model="infoForm.content" useCustomImageHandler @imageAdded="handleImageAdded"
