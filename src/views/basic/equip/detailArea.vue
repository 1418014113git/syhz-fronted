<template>
  <section>
    ...
    <el-table :data="list" v-loading="listLoading" style="width: 100%;" :max-height="tableHeight" :summary-method="getSummaries" show-summary>
      ...
      <el-table-column prop="SL" label="总数量" width="200"></el-table-column>
...
<script>
  ...
  export default {
    ...
    mounted() {
      ...
      console.log('this.thisId', this.thisId)
      this.optionsZblx = [
