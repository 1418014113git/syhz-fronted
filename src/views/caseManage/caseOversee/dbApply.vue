    ...
    <el-row type="flex" justify="center" v-loading="dataLoading">
      <el-col :span="20">
        ...
        <el-form ref="dbForm" :model="dbBean" :rules="rules" label-width="140px">
          ...
          <el-form-item label="附件" prop="superviseDesc">
            <el-input type="textarea" :autosize="{minRows: 8, maxRows: 20}" v-model="dbBean.superviseDesc" class="db_create_input" maxlength="500"></el-input>
          </el-form-item>
          <el-form-item label="查阅密码" prop="superviseDesc">
            <el-input type="textarea" :autosize="{minRows: 8, maxRows: 20}" v-model="dbBean.superviseDesc" class="db_create_input" maxlength="500"></el-input>
          </el-form-item>
          ...
          <el-form-item>
            ...
            <el-button type="primary" @click="onSubmit" v-loading.fullscreen.lock="saveLoading">申请</el-button> -->
            <!-- <p style="font-size: 12px; color: #ffffff">申请后将不能修改和删除</p> -->
            <el-col :span="24" align="center">
              <el-button size="mini" @click="onSubmitEdit('departmentForm')" class="saveBtn" :loading="formLoading" style="margin-left:20px;">保存</el-button>
              <el-button size="mini" @click="cancel()" class="cancelBtn" :loading="formLoading">取消</el-button>
              <el-button size="mini" @click="onSubmit('departmentForm')" class="saveBtn" :loading="formLoading" style="margin-left:20px;">申请</el-button>
            </el-col>
          </el-form-item>
        </el-form>
      </el-col>
