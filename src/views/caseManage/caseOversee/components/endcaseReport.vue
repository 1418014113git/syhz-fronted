  ...
  <section>
    ...
    <div class="auditInfo">
      ...
      <el-table :data="jabgDataList" style="width: 100%;margin-top:20px;" v-loading="loading" class="table_th_center">
        ...
        <el-table-column prop="applyUserName" label="上报人" min-width="120" align="center" show-overflow-tooltip></el-table-column>
        ...
        <el-table-column prop="auditUserName" label="审核人" width="120" align="center" show-overflow-tooltip></el-table-column>
