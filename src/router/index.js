...
export const constantRouterMap = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: '/lyrical/ycReportUpload', component: () => import('@/views/information/lyrical/ycReportUpload'), name: '报告管理' },
      { path: '/lyrical/ycReportList', component: () => import('@/views/information/lyrical/ycReportList'), name: '舆情报告' },
      ...
      { path: '/caseManage/caseAnalysis/developSitutional', component: () => import('@/views/caseManage/caseAnalysis/developSitutional'), name: '发展变化态势报表' },
      { path: '/caseManage/caseAnalysis/featureAnalysis', component: () => import('@/views/caseManage/caseAnalysis/featureAnalysis'), name: '特征信息分析' }
    ]
  },
  ...
  { path: '/exportDevelop', component: () => import('@/views/caseManage/caseAnalysis/exportDevelop'), name: '发展变化态势报表导出页' },
