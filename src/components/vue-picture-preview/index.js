    ...
    Vue.directive('preview', {
      bind: function(el) {
        ...
        el.addEventListener('click', function(e) {
          e.stopPropagation()
          LOGIC_EVENT_BUS.LOGIC_PREVIEW.isTitleEnable = el.getAttribute('preview-title-enable') !== 'false'
          LOGIC_EVENT_BUS.LOGIC_PREVIEW.isHorizontalNavEnable = el.getAttribute('preview-nav-enable') !== 'false'
