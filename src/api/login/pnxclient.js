  ...
  return {
    ...
    Initialize: function(strAlgType, strAuxParam) {
      if (useActioveX) {
        ...
        var str = SendAndWaitMessageEx('Initialize', JSON.stringify(jsonstr))
        if (str) {
    ...
    SetDigestAlg: function(strDigestAlg) {
      if (useActioveX) {
        ...
        var str = SendAndWaitMessageEx('SetDigestAlg', JSON.stringify(jsonstr))
        if (str) {
          var result = JSON.parse(str)
          return result.value
        } else {
    ...
    SetChooseSingleCert: function(isChoose) {
      if (useActioveX) {
        ...
        var str = SendAndWaitMessageEx('SetChooseSingleCert', JSON.stringify(jsonstr))
        if (str) {
          var result = JSON.parse(str)
          return result.value
        } else {
    ...
    AddFilter: function(ulType, strValue) {
      if (useActioveX) {
        ...
        var str = SendAndWaitMessageEx('AddFilter', JSON.stringify(jsonstr))
        if (str) {
          var result = JSON.parse(str)
          return result.value
        } else {
    ...
    ClearFilter: function() {
      if (useActioveX) {
        ...
        var jsonstr = ''
        var str = SendAndWaitMessageEx('ClearFilter', jsonstr)
        if (str) {
          var result = JSON.parse(str)
          return result.value
        } else {
    ...
    P1Sign: function(strValueBase64) {
      if (useActioveX) {
        ...
        var str = SendAndWaitMessageEx('P1Sign', JSON.stringify(jsonstr))
        if (str) {
          var result = JSON.parse(str)
          return result.value
        } else {
    ...
    P1SignString: function(strValue) {
      if (useActioveX) {
        ...
        var str = SendAndWaitMessageEx('P1SignString', JSON.stringify(jsonstr))
        if (str) {
          var result = JSON.parse(str)
          return result.value
        } else {
    ...
    P7Sign: function(strValueBase64, isDetach, isIncludeCert) {
      if (useActioveX) {
        ...
        var str = SendAndWaitMessageEx('P7Sign', JSON.stringify(jsonstr))
        if (str) {
          var result = JSON.parse(str)
          return result.value
        } else {
    ...
    P7SignString: function(strValue, isDetach, isIncludeCert) {
      if (useActioveX) {
        ...
        var str = SendAndWaitMessageEx('P7SignString', JSON.stringify(jsonstr))
        if (str) {
          var result = JSON.parse(str)
          return result.value
        } else {
    ...
    Finalize: function() {
      if (useActioveX) {
        ...
        var jsonstr = ''
        var str = SendAndWaitMessageEx('Finalize', jsonstr)
        if (str) {
          var result = JSON.parse(str)
          return result.value
        } else {
    ...
    GetSignVersion: function() {
      if (useActioveX) {
        ...
        var jsonstr = ''
        var str = SendAndWaitMessageEx('GetSignVersion', jsonstr)
        if (str) {
          var result = JSON.parse(str)
          return result.value
        } else {
    ...
    GetSignCert: function() {
      if (useActioveX) {
        ...
        var jsonstr = ''
        var str = SendAndWaitMessageEx('GetSignCert', jsonstr)
        if (str) {
          var result = JSON.parse(str)
          return result.value
        } else {
    ...
    GetLastError: function() {
      if (useActioveX) {
        ...
        var jsonstr = ''
        var str = SendAndWaitMessageEx('GetLastError', jsonstr)
        if (str) {
          var result = JSON.parse(str)
          return result.value
        } else {
    ...
    GetLastErrorMessage: function() {
      if (useActioveX) {
        ...
        var jsonstr = ''
        var str = SendAndWaitMessageEx('GetLastErrorMessage', jsonstr)
        if (str) {
          var result = JSON.parse(str)
          return result.value
        } else {
    ...
    DestoryAuth: function() {
      if (useActioveX) {
        ...
        var jsonstr = ''
        var str = SendAndWaitMessageEx('DestoryAuth', jsonstr)
        if (str) {
          var result = JSON.parse(str)
          return result.value
        } else {
    ...
    GetSignCertType: function() {
      if (useActioveX) {
        ...
        var jsonstr = ''
        var str = SendAndWaitMessageEx('GetSignCertType', jsonstr)
        if (str) {
          var result = JSON.parse(str)
          return result.value
        } else {
    ...
    GetSignHash: function() {
      if (useActioveX) {
        ...
        var jsonstr = ''
        var str = SendAndWaitMessageEx('GetSignHash', jsonstr)
        if (str) {
          var result = JSON.parse(str)
          return result.value
        } else {
    ...
    CallQueueEnable: function(bCallQueueEnable, bHeadInfoEnable) {
      if (useActioveX) {
        ...
        var str = SendAndWaitMessageEx('CallQueueEnable', JSON.stringify(jsonstr))
        if (str) {
          var result = JSON.parse(str)
          return result.value
        } else {
    ...
    CallQueueClear: function() {
      if (useActioveX) {
        ...
        var jsonstr = ''
        var str = SendAndWaitMessageEx('CallQueueClear', jsonstr)
        if (str) {
          var result = JSON.parse(str)
          return result.value
        } else {
    ...
    CallQueueGet: function() {
      if (useActioveX) {
        ...
        var jsonstr = ''
        var str = SendAndWaitMessageEx('CallQueueGet', jsonstr)
        if (str) {
          var result = JSON.parse(str)
          return result.value
        } else {
    ...
    DoClientSecurityCheck: function(strGatewayAddress, usGatewayPort, strSecurityPolicys) {
      if (useActioveX) {
        ...
        var str = SendAndWaitMessageEx('DoClientSecurityCheck', JSON.stringify(jsonstr))
        if (str) {
          var result = JSON.parse(str)
          return result.value
        } else {
    ...
    GetProtocolVersion: function() {
      if (useActioveX) {
        ...
        var jsonstr = ''
        var str = SendAndWaitMessageEx('GetProtocolVersion', jsonstr)
        if (str) {
          var result = JSON.parse(str)
          return result.value
        } else {
    ...
    ChangePinCode: function(strCertSn, lPinCodeType, strCurPinCode, strNewPinCode) {
      if (useActioveX) {
        ...
        var str = SendAndWaitMessageEx('ChangePinCode', JSON.stringify(jsonstr))
        if (str) {
          var result = JSON.parse(str)
          return result.value
        } else {
    ...
    WaitSetPolicyFinish: function(strGatewayAddress) {
      if (useActioveX) {
        ...
        var str = SendAndWaitMessageEx('WaitSetPolicyFinish', JSON.stringify(jsonstr))
        if (str) {
          var result = JSON.parse(str)
          return result.value
        } else {
    ...
    GetSessionToken: function(strGatewayAddress) {
      if (useActioveX) {
        ...
        var jsonstr = { strGatewayAddress: strGatewayAddress }
        var str = SendAndWaitMessageEx('GetSessionToken', JSON.stringify(jsonstr))
        if (str) {
          var result = JSON.parse(str)
          return result.value
        } else {
    ...
    GetVersion: function() {
      if (useActioveX) {
        ...
        var jsonstr = ''
        var version = SendAndWaitMessageEx('GetVersion', jsonstr)
        if (version) {
          var result = JSON.parse(version)
          return result.value
        } else {
          return version
        }
    ...
    SetLanguage: function(strLanguage) {
      if (useActioveX) {
        ...
        var str = SendAndWaitMessageEx('SetLanguage', JSON.stringify(jsonstr))
        if (str) {
          var result = JSON.parse(str)
          return result.value
        } else {
    ...
    GetAttribute: function(strGatewayAddress, strAppFlag, strAttributeName) {
      if (useActioveX) {
        ...
        var str = SendAndWaitMessageEx('GetAttribute', JSON.stringify(jsonstr))
        if (str) {
          var result = JSON.parse(str)
          return result.value
        } else {
    ...
    GetPinCode: function() {
      if (useActioveX) {
        ...
        var jsonstr = ''
        var str = SendAndWaitMessageEx('GetPinCode', jsonstr)
        if (str) {
          var result = JSON.parse(str)
          return result.value
        } else {
